local keyboard = keyboard(merge(safe_require("nekocat.layouts.38keys3x5b1"), keyboard {
  ...
  rows = {
    ...
    [2] = {
      keys = {
        [2] = key { hint = { { text = "a an ang", color = "blue" } } },
        [3] = key { hint = { { text = "ai ei ao", color = "blue" } } },
        [4] = key { hint = { { text = "o ou ong", color = "blue" } } },
        [5] = key { hint = { { text = "e en eng", color = "blue" } } },
        [6] = key { hint = { { text = "er üan", color = "blue" } } }
      }
    },
    [3] = {
      keys = {
    ...
    [4] = {
      keys = {
        [2] = key { hint = { { text = "ua uan uang", color = "blue" } } },
        [3] = key { hint = { { text = "uai ui", color = "blue" } } },
        [4] = key { hint = { { text = "uo u", color = "blue" } } },
        [5] = key { hint = { { text = "∅ un ueng", color = "blue" } } },
        [6] = key { hint = { { text = "üe ün", color = "blue" } } }
      }
    }
  }
}))
