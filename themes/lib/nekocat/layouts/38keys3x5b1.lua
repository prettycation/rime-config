  ...
  rows = {
    ...
    row {
      keys = {
        ...
        key(merge(S.n, key { label = { { text = "u s" } }, click = "b", label_symbol = { { text = { "U/S", "ic@ideogram-cjk", "~" }, align = "justify" } }, swipe_up = "~", popup = { "ZiTools", "U", "S", "u", "s" }, key_text_size = main_key_text_size })),
