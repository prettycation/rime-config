  ...
  rows = {
    ...
    row {
      keys = {
        ...
        key(merge(S.e, key { label = { { text = "b" } }, click = "q", label_symbol = { { text = { "A", " ", "\"" }, align = "justify" } }, swipe_up = "\"", popup = { "B", "A", "b", "a" }, key_text_size = main_key_text_size })),
        key(merge(S.r, key { label = { { text = "p" } }, click = "w", label_symbol = { { text = { "E", " ", "+" }, align = "justify" } }, swipe_up = "+", popup = { "P", "E", "p", "e" }, key_text_size = main_key_text_size })),
        key(merge(S.t, key { label = { { text = "m" } }, click = "e", label_symbol = { { text = { "O", " ", "-" }, align = "justify" } }, swipe_up = "-", popup = { "M", "O", "m", "o" }, swipe_down = "KeyboardEditor", key_text_size = main_key_text_size })),
