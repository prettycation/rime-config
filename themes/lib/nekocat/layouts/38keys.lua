...
local action_rows = safe_require("nekocat.layouts._action_row")({ has_menu = true })
  ...
  rows = {
    ...
    row {
      keys = {
        ...
        key(merge(S.e, key { label = { { text = "b" } }, click = "q", label_symbol = { { text = { "B/A", " ", "\"" }, align = "justify" } }, swipe_up = "\"", popup = { "B", "A", "b", "a" }, key_text_size = main_key_text_size })),
        key(merge(S.r, key { label = { { text = "p" } }, click = "w", label_symbol = { { text = { "P/E", " ", "+" }, align = "justify" } }, swipe_up = "+", popup = { "P", "E", "p", "e" }, key_text_size = main_key_text_size })),
        key(merge(S.t, key { label = { { text = "m" } }, click = "e", label_symbol = { { text = { "M/O", " ", "-" }, align = "justify" } }, swipe_up = "-", popup = { "M", "O", "m", "o" }, swipe_down = "KeyboardEditor", key_text_size = main_key_text_size })),
        ...
        key(merge(S.clear, key { click = "Clear", key_text_size = func_key_text_size, width = 0.11 }))
      }
    },
    row {
      keys = {
        key(merge(S.left, key { click = "Left", key_text_size = func_key_text_size, width = 0.11 })),
        ...
        key(merge(S.right, key { click = "Right", key_text_size = func_key_text_size, width = 0.11 }))
      }
    },
    row {
      keys = {
        ...
        key(merge(S.x, key { label = { { text = "g j" } }, click = "z", label_symbol = { { text = { "G/J", "ic@select-all", "{" }, align = "justify" } }, swipe_up = "{", popup = { "G", "J", "g", "j", "SelectAll" }, key_text_size = main_key_text_size })),
