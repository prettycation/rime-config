local keyboard = keyboard(merge(safe_require("nekocat.layouts.38keys3x5b2"), keyboard {
  name = "万象·李氏三拼3x5b2",
  rows = {
    [1] = row {
      keys = {
    ...
    [2] = {
      keys = {
        ...
        [4] = key { hint = { { text = "er üan", color = "blue" } } },
    ...
    [4] = {
      keys = {
        ...
        [4] = key { hint = { { text = "üe ün", color = "blue" } } },
